	...
	public void setupConfigManager(File file) {
        ...
        cfgManager.register(serverConfigCategory, new IConfigHandler() {
			...
			public void setupConfig(Configuration config, String category) {
		        ...
		        serverEnabled.setRequiresWorldRestart(true);
		        ...
		        day.setRequiresWorldRestart(true);
		        ...
		        year.setRequiresWorldRestart(true);
		        ...
		        propNameList.add(dayOffset.getName());
		       	...
		       	tickOffset.setRequiresWorldRestart(true);
		        ...
		        propNameList.add(tickOffset.getName());
		       	...
		       	latitudeOverworld.setRequiresWorldRestart(true);
		        ...
		        propNameList.add(latitudeOverworld.getName());
		       	...
		       	longitudeOverworld.setRequiresWorldRestart(true);
		        ...
		        propNameList.add(longitudeOverworld.getName());
		       	...
		       	latitudeEnder.setRequiresWorldRestart(true);
