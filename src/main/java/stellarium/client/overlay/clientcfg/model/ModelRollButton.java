...
public class ModelRollButton implements IRenderModel {
	...
	public void renderModel(String info, IRectangleBound totalBound, IRectangleBound clipBound, Tessellator tessellator,
		...
		if(info.equals("down") || info.equals("up")) {
			...
			round1.renderModel(info, temporal, temporalClip, tessellator, textureManager, color);
			...
			temporalClip.set(clipBound);
			temporalClip.setAsIntersection(temporal);
			round2.renderModel(info, temporal, temporalClip, tessellator, textureManager, color);
