...
public class ModelRollButtonWithoutClick implements IRenderModel {
	...
	public void renderModel(String info, IRectangleBound totalBound, IRectangleBound clipBound, Tessellator tessellator,
		...
		if(info.equals("vertical")) {
			...
			round.renderModel(info, temporal, temporalClip, tessellator, textureManager, color);
			...
			temporalClip.set(clipBound);
			temporalClip.setAsIntersection(temporal);
			roundRefl.renderModel(info, temporal, temporalClip, tessellator, textureManager, color);
			...
			temporalClip.set(clipBound);
			temporalClip.setAsIntersection(temporal);
			parallel.renderModel(info, temporal, temporalClip, tessellator, textureManager, color);
			...
			temporalClip.set(clipBound);
			temporalClip.setAsIntersection(temporal);
			scroll.renderModel(info, temporal, temporalClip, tessellator, textureManager, color);
