...
public class HorGridSettings extends PerDisplaySettings {
	...
	public void setupConfig(Configuration config, String category) {
        ...
        propDisplayEnabled.setComment("Set to true to enable display of horizontal coordinate grid.");
        ...
        propDisplayFrag.setComment("Number of fragments of display grids in direction of height.");
        ...
        propHorizonEnabled.setComment("Set to true to enable display of horizon.");
        ...
        propGridEnabled.setComment("Set to true to enable display of horizontal grid.");
        ...
        propDisplayHeightColor.setComment("Color factor for height, the grid tends to have this color when height gets bigger.");
        ...
        propDisplayAzimuthColor.setComment("Color factor for azimuth(horizontal position), the grid tends to have this color when azimuth gets bigger.");
