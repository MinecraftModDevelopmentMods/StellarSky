...
public class EcOverlayCache implements IDisplayRenderCache<EcOverlaySettings> {
	...
	@Override
	public void initialize(ClientSettings settings, EcOverlaySettings specificSettings) {
	...
	@Override
	public void updateCache(ClientSettings settings, EcOverlaySettings specificSettings, StellarCacheInfo info) {
		if(!this.enabled)
			return;
