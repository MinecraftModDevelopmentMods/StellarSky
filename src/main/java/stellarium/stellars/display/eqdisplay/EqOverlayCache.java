...
public class EqOverlayCache implements IDisplayRenderCache<EqOverlaySettings> {
	...
	@Override
	public void initialize(ClientSettings settings, EqOverlaySettings specificSettings) {
	...
	@Override
	public void updateCache(ClientSettings settings, EqOverlaySettings specificSettings, StellarCacheInfo info) {
		if(!this.enabled)
			return;
