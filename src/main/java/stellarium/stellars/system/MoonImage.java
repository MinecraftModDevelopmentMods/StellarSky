...
public class MoonImage implements IPerWorldImage<Moon> {
	...
	@Override
	public void initialize(Moon object, ICCoordinates coordinate, IAtmosphereEffect sky, CelestialPeriod yearPeriod) {
	...
	@Override
	public void updateCache(Moon object, ICCoordinates coordinate, IAtmosphereEffect sky) {
		this.pos = new Vector3(object.earthPos);
