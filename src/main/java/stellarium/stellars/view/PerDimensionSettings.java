...
public class PerDimensionSettings implements INBTConfig {
	...
	public double skyDispersionRate;
	...
	private Property propSkyDispersionRate;
	...
	public void setupConfig(Configuration config, String category) {
        ...
        propSkyDispersionRate = config.get(category, "Sky_Dispersion_Rate", 1.0);
        propSkyDispersionRate.comment = "Relative strength of sky dispersion on the dimension.\n"
        ...
        propNameList.add(propSkyDispersionRate.getName());
	...
	public void loadFromConfig(Configuration config, String category) {
   		...
   		this.skyDispersionRate = propSkyDispersionRate.getDouble();
	...
	public void readFromNBT(NBTTagCompound compound) {
       	...
       	this.skyDispersionRate = compound.getDouble("skyDispersionRate");
	...
	public void writeToNBT(NBTTagCompound compound) {
       	...
       	compound.setDouble("skyDispersionRate", this.skyDispersionRate);
	...
	public INBTConfig copy() {
		...
		settings.skyDispersionRate = this.skyDispersionRate;
