...
public class StellarWorldProviderEnd extends WorldProviderEnd {
	...
	public StellarWorldProviderEnd(World world, WorldProvider provider, ICelestialHelper celestialHelper) {
	...
	public float getMixedBrightnessOnBlock(BlockPos pos) {
		...
		return (((state.getBlock().getMixedBrightnessForBlock(worldObj, pos) & 0xff)) >> 4)
				* 0.005f;
	}
